...
| Data classes and attribution are visible | 21.4, 34.19 | frontend/components/ui/provenance.tsx | frontend/components/ui/provenance.test.tsx, frontend/lib/design/data-class.test.ts, frontend/lib/design/product-copy.test.ts | IMPLEMENTED |
