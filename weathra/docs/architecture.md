...
| Requirement | Tasks | Implementation | Tests | Status |
|---|---|---|---|---|
| Historical observation retrieval | 8.8, 34.25 | weather/history_service.py, frontend/components/historical/charts.tsx, frontend/components/historical/sections.tsx | unit/test_weather_services.py, frontend/lib/historical/analysis.test.ts, frontend/components/historical/historical.test.tsx | IMPLEMENTED |
...
| Weather watches | 34.17 | analytics/watch.py, memory/watches.py, memory/watch_monitoring.py, weather/watch_evaluator.py, weather/watch_schedule.py, api/routers/watches.py, db/migrations/versions/0012_weather_watches.py, db/migrations/versions/0013_weather_watch_grant_repair.py, db/migrations/versions/0014_weather_watch_monitoring.py | unit/test_watch_evaluation.py, unit/test_watch_analytics.py, integration/test_memory_saved_locations.py, integration/test_watch_monitoring.py, test_watch_schedule_workflow.py | IMPLEMENTED |
...
| A route that is not built says so, and every screen reserved here is now built | 21.7 | frontend/lib/routes.ts, frontend/lib/navigation.ts | frontend/lib/routes.test.ts, frontend/lib/navigation.test.ts | IMPLEMENTED |
...
| Weather Watch | 34.17 | frontend/components/watch/watch.tsx, frontend/app/(app)/watch/page.tsx | frontend/components/watch/watch.test.tsx | IMPLEMENTED |
| Data classes and attribution are visible | 21.4, 34.19, 34.20 | frontend/components/ui/provenance.tsx | frontend/components/ui/provenance.test.tsx, frontend/lib/design/data-class.test.ts, frontend/lib/design/product-copy.test.ts | IMPLEMENTED |
...
| Accessibility and responsive layout | 21.8, 34.19, 34.20, 34.25 | frontend/components/shell/, frontend/app/globals.css, frontend/components/admin/admin.module.css, docs/design/design-system.md | frontend/tests/accessibility.test.tsx, frontend/tests/e2e/accessibility.spec.ts, frontend/tests/e2e/axe.spec.ts, frontend/lib/design/contrast.test.ts, frontend/tests/e2e/capture.spec.ts | MANUAL |
