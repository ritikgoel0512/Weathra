/**
 * How a figure is *read* — presentation only, and shared by every analytical screen.
 *
 ...
 *
 * So the precision is a property of the **unit**, in one table, used by every surface that shows a
 * figure — the Weather Intelligence Report, and the Scenario Lab that borrowed its standard:
 *
